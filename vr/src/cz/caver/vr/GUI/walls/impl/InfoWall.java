 ...
 */
public class InfoWall extends GUIPanel {
    private Label findLabel;
    
    public InfoWall(VirtualReality vr) {
        super(vr);
        this.key = InfoWall.class.getCanonicalName();
        this.name = InfoWall.class.getSimpleName();
        ...
        wireframeToggleButton.setLeftTopOffset(new Vector3f(100, 250, 0));
        ...
        sticksToggleButton.setLeftTopOffset(new Vector3f(250, 250, 0));
        ...
        vdwToggleButton.setLeftTopOffset(new Vector3f(400, 250, 0));
        ...
        cartoonToggleButton.setLeftTopOffset(new Vector3f(550, 250, 0));
