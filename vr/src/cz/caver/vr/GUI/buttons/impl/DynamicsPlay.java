 ...
 */
public class DynamicsPlay extends Button {
    private static DynamicsController dynamicsController = Lookup.getDefault().lookup(DynamicsController.class);

    public DynamicsPlay(IVRGUIPanel panel) {
        super(panel);
        
        GL2GL3 gl = panel.getVR().getGL();
        defaultTexture = loadTexture(gl, "/resources/textures/dynamics_forward_128.png", TextureIO.PNG);
    }
